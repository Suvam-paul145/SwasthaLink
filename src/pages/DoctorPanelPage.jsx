...
function DoctorPanelPage() {
  ...
  const handleUploadPrescription = async () => {
    ...
    try {
      ...
      // Patient ID is auto-generated by the system — not manually selected
      const systemPatientId = generatePatientId();
                ...
                <div className="rounded-2xl border border-white/10 bg-[#0d1f2d] px-3 py-3 flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center justify-between">
                      ...
                      {autoPatientId && (
                        <button 
                          onClick={() => copyToClipboard(autoPatientId, () => {
                            setCopiedId(autoPatientId);
                            setTimeout(() => setCopiedId(null), 2000);
                          })}
                          className="text-teal-400 hover:text-white transition-colors"
                        >
                          <span className="material-symbols-outlined text-sm">
                            {copiedId === autoPatientId ? 'check' : 'content_copy'}
                          </span>
                        </button>
                      )}
                    </div>
            ...
            <div className="glass-card rounded-3xl border border-white/10 overflow-hidden">
              ...
              <div className="p-5 space-y-4">
                <div className="rounded-xl bg-white/[0.03] border border-white/10 px-4 py-3 text-xs text-slate-300 flex flex-wrap items-center gap-2">
                  <span className="font-semibold text-white">Patient ID:</span> {autoPatientId || <span className="italic text-slate-400">Will be auto-assigned</span>}
